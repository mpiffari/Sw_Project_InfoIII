...
\begin{itemize}
	\item \textbf{Componente \textit{Book registration:}} La componente “Book Registration” fa riferimento all’ UC5, ovvero alla funzione di aggiunta di un libro alla rete di Book Crossing. La componente si presenta nel seguente modo:
	\begin{itemize}
