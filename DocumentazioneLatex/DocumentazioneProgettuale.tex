...
\begin{tabular}{|l|l|l|l|l|l||r}
	\hline
	\textbf{Nome requisito} & \textbf{ID requisito} & \textbf{Tipologia} & \textbf{Priorità} & \textbf{Descrizione} & \textbf{Requisiti padre} & \textbf{Requisiti figli} \\
	\hline
	...
	Visualizzazione profilo personale  & UR11 & funzionale & media & & UR2 &\\
			\hline
	Controllo geolocalizzazione & UR12 & non funzionale & & Funzionalità che permette di verificare che la posizione GPS 
