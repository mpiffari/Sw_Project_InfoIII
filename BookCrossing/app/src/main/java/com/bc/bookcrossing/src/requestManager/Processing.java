...
/**
 *
 * Strato che si permette alla parte di GUI di interfacciarsi al componente di comunicazione verso il
 * server, andando a mettere a disposizione due interfacce (GenerateRequests, ReceiveAnswer).
 *
